...
push rbp 								;prologue 
mov rbp, rsp 
sub rsp, 52                   			;create 52 charcters array ,binaryString
sub rsp, 1 								;create tempChr
...
push r8
	...
	lea rbx, [rbp-52] 		 			;grab the base Address
	mov r12,0							;i = 0
	...
	leadingSpace:
		...
		lea rsi, [rbp-53] 		;address of tempChr 
		mov rdx, 1				;how many charcters to read 
		syscall 			

		mov rcx, 0				;clear
		mov cl, byte[rbp-53]	;get charcters just to read 
	...
	mov byte[(rbp-52)+r12],NULL ;PLACE NULL AT THE LAST CHARACTER
	...
	lea rbx, [rbp-52] 		;get the base address of binaryString
